...
const SIGNIN_URL = APP_URL ? `${APP_URL.replace(/\/$/, "")}/signin` : "#";
const SIGNUP_URL = APP_URL ? `${APP_URL.replace(/\/$/, "")}/signup` : "#";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#080808] transition-colors duration-300 scroll-smooth">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 lg:pt-24 lg:pb-24">
          ...
          >
            <p className="text-base text-[#666666] dark:text-[#999] max-w-md leading-relaxed">
              Our{" "}
              <span className="font-bold text-[#080808] dark:text-white">
                AI-powered
              </span>{" "}
              platform automates resume screening with{" "}
              <span className="font-bold text-[#080808] dark:text-white">
                99.7% accuracy
              </span>
      ...
      <section
        id="features"
        className="border-t border-[#F0F0F0] dark:border-[#2D2D2D] scroll-mt-16"
      >
          ...
          >
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }}>
              ...
              <p className="text-sm text-[#666666] dark:text-[#999] leading-relaxed">
                Build the ideal candidate profile. Set custom weights for
                specific skills, education, and years of experience to ensure
                the AI ranks candidates based on what matters most for any
                given role.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }}>
              ...
              <p className="text-sm text-[#666666] dark:text-[#999] leading-relaxed">
                Our proprietary AI engine goes beyond keywords to understand
                context and proficiency. It analyzes and scores every resume
                instantly, surfacing the top candidates with unmatched accuracy
                and objectivity.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }}>
              ...
              <p className="text-sm text-[#666666] dark:text-[#999] leading-relaxed">
                Access a central dashboard to monitor key hiring metrics. Track
                time-to-hire, diversity statistics, and top performer sources
                to make data-driven decisions and optimize your recruitment
                process.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }}>
              ...
              <p className="text-sm text-[#666666] dark:text-[#999] leading-relaxed">
                Built for enterprise scale with best-in-class security and data
                compliance. Collaborate with granular permissions and seamlessly
                connect with your existing ATS and HR tech stack via native
                integrations.
              </p>
            </motion.div>
          </motion.div>
      ...
      <section
        id="platform"
        className="bg-white dark:bg-[#080808] scroll-mt-16"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            >
              <p className="text-base text-[#666666] dark:text-[#999] leading-relaxed max-w-md">
                Our AI-powered platform does more than parse CVs — it
                understands them. From intelligent campaign creation to
                real-time scoring insights, we help you attract, screen, and
                select candidates who truly match your needs.
              </p>
              ...
              <div className="mt-10 border-t border-[#E5E5E5] dark:border-[#2D2D2D] pt-8">
                ...
                <p className="text-sm text-[#666666] dark:text-[#999] leading-relaxed">
                  Emphasize or de-emphasize any criteria, from specific
                  programming languages to years of experience.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-0">
          ...
          >
            ...
            <p className="mt-3 text-sm text-[#666666] dark:text-[#999] leading-relaxed">
              Emphasize or de-emphasize any criteria, from specific programming
              languages to years of experience.
            </p>
          </motion.div>
      ...
      <section
        id="demo"
        className="bg-white dark:bg-[#080808] scroll-mt-16 pt-29"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <motion.div
            variants={fadeUp}
          ...
          >
            ...
            <p className="mt-4 text-sm text-[#666666] dark:text-[#999] leading-relaxed">
              This is a simplified, interactive preview of our platform. Adjust
              the scoring criteria below and watch how the candidate shortlist
              instantly re-ranks in real-time.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 space-y-20 lg:space-y-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-4 text-sm text-[#666666] dark:text-[#999] leading-relaxed max-w-sm">
                Easily sync with hiring managers and stakeholders. Create and
                manage job campaigns together — all from one dashboard.
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-4 text-sm text-[#666666] dark:text-[#999] leading-relaxed max-w-sm">
                Data privacy is at our core. We follow industry-grade
                encryption and compliance standards to protect your
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="mt-4 text-sm text-[#666666] dark:text-[#999] leading-relaxed max-w-sm">
                Connect effortlessly with your existing HR stack — from CRMs to
                job boards — using our robust API and no-code integrations.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          >
            <motion.div
              ...
              className="border border-[#E5E5E5] dark:border-[#2D2D2D] rounded-xl p-8 flex flex-col"
            >
              <h3 className="text-2xl font-bold text-[#080808] dark:text-white">
                Free
              </h3>
              <div className="mt-4 mb-2">
                <span className="text-5xl font-bold text-[#080808] dark:text-white">
                  $0
                </span>
                <span className="text-[#666666] dark:text-[#999] ml-2">
                  forever
                </span>
              </div>
              ...
              <div className="flex-1">
                <p className="font-semibold text-[#080808] dark:text-white text-sm mb-3">
                  What&apos;s included:
                </p>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={f} className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-[#080808] dark:text-white">
                        {f}
                      </span>
                    </li>
                  ))}
                ...
                <p className="font-semibold text-[#080808] dark:text-white text-sm mb-3 mt-6">
                  Limitations:
                </p>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={l} className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-[#666666] dark:text-[#999]">
                        {l}
                      </span>
                    </li>
                  ))}
            ...
            <motion.div
              variants={fadeUp}
              transition={{ duration: 0.5 }}
              className="relative border-2 border-[#16A34A] rounded-xl p-8 flex flex-col ring-2 ring-[#16A34A]/20"
            >
          ...
          >
            <div>
              ...
              <p className="mt-3 text-[#999] text-base max-w-md">
                Join hundreds of teams already using Hiretics to find top talent
                faster.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10">
            <div className="col-span-2 md:col-span-4 lg:col-span-1">
              ...
              <p className="mt-4 text-sm text-[#888] leading-relaxed max-w-xs">
                AI-powered resume screening that helps you find the best
                candidates in seconds, not days.
              </p>
              <div className="flex items-center gap-3 mt-6">
                <a
                  href="#"
                  className="w-9 h-9 rounded-lg bg-[#1a1a1a] hover:bg-[#2a2a2a] flex items-center justify-center transition-colors"
                  aria-label="Twitter"
                >
                  <svg
                    width="16"
