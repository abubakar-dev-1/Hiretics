...
export function ShareDialog({ open, onOpenChange, url, title = "Share Campaign" }: ShareDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Share this campaign link with others
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center justify-center gap-4 pt-2">
          ...
          {/* Email */}
          <a
            href={`mailto:?subject=${encodeURIComponent("Check out this campaign")}&body=${shareText}%20${encodeURIComponent(url)}`}
            className="flex items-center justify-center w-10 h-10 rounded-full bg-[#6B7280] text-white hover:opacity-90 transition-opacity"
